...
class BaseStage extends FlxBasic
{
	...
	public var freeplayCutscenes(get, never):Bool;
	public var seenCutscene(get, never):Bool;
	public var inCutscene(get, set):Bool;
	public var canPause(get, set):Bool;
	public var dsFilterOn(get, never):Bool;
	public var curPlayer(get, never):Int;
	...
	public var camDialogue(get, never):FlxCamera;
	...
	inline private function get_freeplayCutscenes() return ClientPrefs.data.freeplayCutscenes;
	inline private function get_seenCutscene() return PlayState.seenCutscene;
	inline private function get_dsFilterOn() return game.dsFilterOn;
	inline private function get_inCutscene() return game.inCutscene;
	inline private function get_curPlayer() return ClientPrefs.data.playerChar;
	...
	inline private function get_camDialogue():FlxCamera return game.camDialogue;
