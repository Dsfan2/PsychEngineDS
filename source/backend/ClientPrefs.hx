...
class SaveVariables {
	...
	public var dsFilter:Bool = false;
	public var dsBorder:String = 'None';
	public var playerChar:Int = 1;
	public var songBlurb:Bool = true;
	public var freeplayCutscenes:Bool = false;
	public var resultsScreen:Bool = true;
	public var fullscreen:Bool = false;
	public var comboHUDDir:String = 'Default';
	public var healthAndTimeBars:String = 'Default';
...
class ClientPrefs {
	...
	public static var gamepadBinds:Map<String, Array<FlxGamepadInputID>> = [
		...
		'note_extra'	=> [LEFT_SHOULDER, RIGHT_SHOULDER],
