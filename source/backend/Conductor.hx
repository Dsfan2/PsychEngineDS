...
class Conductor
{
	...
	public static function judgeNote(arr:Array<Rating>, diff:Float=0):Rating // die
	{
		...
		for(i in 0...data.length-1) //skips last window (Trash)
	...
	public static function beatToSeconds(beat:Float): Float{
		...
		return lastChange.songTime + ((step - lastChange.stepTime) / (lastChange.bpm / 60)/4) * 1000; // TODO: make less garbo and take BPM into account PROPERLY
	}
