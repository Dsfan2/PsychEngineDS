...
class Controls
{
	...
	//Also idk how to use macros they're weird as peck lol
	...
	private function get_NOTE_EXTRA_P() return justPressed('note_extra');
	...
	private function get_NOTE_EXTRA() return pressed('note_extra');
	...
	private function get_NOTE_EXTRA_R() return justReleased('note_extra');
