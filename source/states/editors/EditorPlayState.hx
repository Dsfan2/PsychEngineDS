...
class EditorPlayState extends MusicBeatSubstate
{
			...
			for (songNotes in section.sectionNotes)
			{
				...
				if(floorSus > 0) {
					for (susNote in 0...floorSus+1)
					{
						...
						var sustainNote:Note = new Note(daStrumTime + (Conductor.stepCrochet * susNote), daNoteData, oldNote, true, true);
	...
	private function cachePopUpScore()
	{
		...
		uiPrefix = 'hudFolders/${PlayState.stageUI}UI/';
		if (PlayState.isPixelStage){
			uiPrefix = 'pixelUI/hudFolders/${PlayState.stageUI}UI/';
			uiSuffix = '-pixel';
		}
	...
	private function popUpScore(note:Note = null):Void
	{
		...
		var pixeltrashPart1:String = "";
		var pixeltrashPart2:String = '';
	...
	function fullComboUpdate()
	{
		...
		var trashes:Int = ratingsData[3].hits;
